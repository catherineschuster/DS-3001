...
kennedy_inag <- gutenberg_download(3, mirror="http://mirrors.xmission.com/gutenberg/") 

#had to use a new mirror as the default mirror was down, list of mirrors is here: https://www.gutenberg.org/MIRRORS.ALL
...
trump_inag <- read_lines("/Users/catherineschuster/Desktop/Fall 2021/DS 3001/DS-3001-Main/07_text_mining/trump_inag.txt")
...
biden_inag <- read_lines("/Users/catherineschuster/Desktop/Fall 2021/DS 3001/DS-3001-Main/07_text_mining/biden_inag.txt")
...
Here we are going to treat each of our speeches as a document in a corpus and explore the relative importance of words to these speeches as compared to the overall corpus. 

```{r}
#need to the raw data again
kennedy_inag_raw <- gutenberg_download(3, mirror="http://mirrors.xmission.com/gutenberg/")

trump_inag_raw <- as_tibble(read_lines("/Users/catherineschuster/Desktop/Fall 2021/DS 3001/DS-3001-Main/07_text_mining/trump_inag.txt"))

biden_inag_raw <- as_tibble(read_lines("/Users/catherineschuster/Desktop/Fall 2021/DS 3001/DS-3001-Main/07_text_mining/biden_inag.txt"))
